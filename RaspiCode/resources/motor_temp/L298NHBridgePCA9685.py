...
# 60Hz is the working frequency for Servos. 
PCA9685_pwm.set_pwm_freq(60)

# The variable duty_cycle specifies the maximum duty cycle of the 
# motors per 100 herts. This is between 0 to 4095. For the speed 
# of the motors, the duty cycle always starts at 0 and 
